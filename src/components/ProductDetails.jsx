    ...
    <div className='container'>
        <div className="row">
          <div className="col-md-12 text-center">
            <h3 className="display-3 text-danger">ProductDetails</h3>
            </div>
            </div>
            <div className="row">
                ...
                <div id="pro" className="carousel slide" data-bs-ride="carousel">
                  ...
                  <div className="carousel-inner" style={{ height:'300px'}}>
                    <div className="carousel-item active">
                      <img src={product.thumbnail} alt="no found" className="d-block w-100" />
                    </div>
                    {
                      product.img && product.img.map((item,index)=>{
                        return(
                          <div className="carousel-item" key={index}>
                            <img src={item} alt=" not found" className="d-block w-100" />
                          </div>
                        )
                      })
                    }
